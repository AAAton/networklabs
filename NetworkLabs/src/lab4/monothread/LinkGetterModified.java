...
public class LinkGetterModified extends HTMLEditorKit.ParserCallback {
    ...
    public LinkGetterModified(String url) {
        baseURL = url;
    }

    public LinkGetterModified(Writer out) {
        super();
        this.out = out;
    }
...
//                System.out.println("\tAbsolute link: " + new URL(new URL(baseURL), href));
    ...
    public static void main(String[] args) {
        ...
        HTMLEditorKit.ParserCallback callback = new LinkGetterModified(new OutputStreamWriter(System.out));
        try {
